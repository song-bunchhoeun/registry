            ...
            <div className={styles.table_container}>
                <table className={styles.table}>
                    <tbody>
                        ...
                        {(document.certificate.examDateKm || document.certificate.examDate) ?
                            <>
                                <tr>
                                    <td colSpan={2}>
                                        <div className={styles.line}></div>
                                ...
                                <tr>
                                    <th>
                                        <span className={googleSans.className}>Examination dated</span>
                                    </th>
                                    <td>
                                        <span className={googleSans.className}>
...
export default function NIEMasterCertificateTableLayout({ document }) {
    return (
        <div>
