...
const KhmerOsMoul = localFont({
    src: [
        {
            path: '../assets/fonts/Moul-Regular.ttf',
            weight: '400',
            style: 'normal',
        },
    ],
                ...
                <table className={styles.table}>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span className={KhmerOsMoul.className}>{document.recipient.nameKm}</span>
                            </td>
                        </tr>
                        <tr>
                            <th>
...
export default function RUPPMasterCertificateTableLayout({ document }) {
    return (
        <div>
