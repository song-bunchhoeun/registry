                ...
                <table className={styles.table}>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <span>សាកលវិទ្យាល័យជាតិជាស៊ីមកំចាយមារ</span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td >
                                <strong className={googleSans.className}>NATIONAL UNIVERSITY OF CHEASIM KAMCHAYMEAR</strong>
                            </td>
                        </tr>
                        <tr>
                            <td colSpan={2}>
                        ...
                        <tr>
                            ...
                            <td>
                                <strong>កំចាយមារ, {document.certificate.chairmanSignatureDateKm}</strong>
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <span className={googleSans.className}>
                                    <strong>Kamchaymear, {document.certificate.rectorSignatureDate}</strong>
                                </span>
                            </td>
                        </tr>
                    </tbody>
...
export default function NUCKCertificateTableLayout({ document }) {
    return (
        <div>
