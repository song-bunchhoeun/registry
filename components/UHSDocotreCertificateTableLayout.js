                ...
                <table className={styles.table}>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <strong>{document.certificate.thesisDateKm}</strong>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span>
                                    <strong>{document.certificate.thesisDate}</strong>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <span>
                                    <strong>{document.certificate.thesisDateFr}</strong>
                                </span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <strong>{document.certificate.deanSignatureLunarDateKm}</strong>
                                <br />
                                <strong>រាជធានីភ្នំពេញ ថ្ងៃទី/Phnom Penh, {document.certificate.deanSignatureDate}</strong>
                            </td>
                        </tr>
                        <tr>
                            <td colSpan={2}>
...
export default function UHSDoctoreCertificateTableLayout({ document }) {
    return (
        <div>
