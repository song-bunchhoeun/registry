            ...
            <div className={styles.table_container}>
                <table className={styles.table}>
                    <tbody>
                        ...
                        <tr>
                            <th>
                                <span className={googleSans.className}>Examination of</span>
                            </th>
                            <td>
                                <span className={googleSans.className}>
                        ...
                        <tr>
                            <th>
                                <span className={googleSans.className}>Examination date</span>
                            </th>
                            <td>
                                <span className={googleSans.className}>
...
export default function NIEInspectorCertificateTableLayout({ document }) {
    return (
        <div>
