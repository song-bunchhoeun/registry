...
export async function createAUPPMasterCertificate2022(certificateInfo = {}, qrcodeContent) {
    ...
    const AUPP_TEMPLATE_IMAGE = 'certificate-aupp-bachelor-2022-no-logo.png'
    let AUPP_TEXTS = [
        {
    ...
    if ( certificateInfo.certificate.major && certificateInfo.certificate.major !== "null") {
        AUPP_TEXTS.push(
            {
