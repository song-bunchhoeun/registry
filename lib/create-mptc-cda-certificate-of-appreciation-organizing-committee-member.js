...
export async function createMPTCCDACertificateOfAppreciationOrganizingCommitteeMember(
  certificateInfo = {},
  qrcodeContent
) {
  ...
  drawWrapTexts(ctx, {
    ...
    spans: [
      {
        text: `as an ${getRoleDescription("oc", certificateInfo)}`,
        fontSize: 75,
        fontFamily: MPTC_FONTS.primary,
        fillStyle: MPTC_TEXT_COLORS.blue,
        fontWeight: "500",
  ...
  drawWrapTexts(ctx, {
    ...
    spans: [
      {
        text: `of the Cambodia Digital Awards 2024`,
        fontSize: 75,
        fontFamily: MPTC_FONTS.primary,
        fillStyle: MPTC_TEXT_COLORS.blue,
        fontWeight: "500",
