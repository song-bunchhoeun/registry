...
export async function createSercSecuritiesClearingSettlementAuthorizationCertificateCanvas(
    certificateInfo = {},
    qrcodeContent
) {
    ...
    const COMPANY_TEXT_MAX_WIDTH_1 = 520;
    ...
    const SERC_TEXTS = [
        ...
        },
        {
            ...
            text: `ផ្ដល់ការអនុញ្ញាតធ្វើជាប្រតិបត្តិករប្រព័ន្ធផាត់ទាត់និងទូទាត់មូលបត្រ`,
            textSize: 43,
            textFont: MPTC_FONTS.thrirdly,
            textColor: MPTC_TEXT_COLORS.black,
            fontWeight: "400",
