...
export async function createMPTCDataGovernanceCertCanvas(certificateInfo = {}, qrcodeContent) {
    ...
    const MPTC_FONTS = {
        ...
        secondary: 'Google Sans Bold',
        thirdly: 'Niradei',
    };
   
    const MPTC_TEMPLATE_IMAGE = 'certificate-gda-data-governance-workshop.png';
    const MPTC_TEXTS = [
        {
        ...
        },     
        {
            ...
            text: 'ចាបពី{certificate.dateKh} នៅ {certificate.locationKh}។',
            textSize: 48,
            textStyle: 'meduim',
        ...
        },
        {
            ...
            text: '{certificate.dateEn} at {certificate.locationEn}',
            textSize: 46,
            textStyle: 'normal',
            textColor: MPTC_TEXT_COLORS.black,
            textFont: MPTC_FONTS.secondary,
    ...
    if (qrcodeContent) {
        await drawQrCodeStandard(qrcodeContent, ctx, 1955, 2982, 268); 
    }
    return canvas;
}
