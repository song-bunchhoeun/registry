...
export async function createBIUIpAssociateCertificate(
  certificateInfo = {},
  qrcodeContent
) {
  const DATA = {
    BACKGROUND: {
      ...
      pngFilename: "biu-associate-ip-certificate-2x.png",
    },
    FONTS: [
  ...
  drawWrapTexts(ctx, {
    ...
    spans: [
      {
        text: "This Associate degree is presented to the bearer with",
        fontSize: 110,
