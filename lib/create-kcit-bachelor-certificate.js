...
export async function createKCITBachelorCertificate(
  certificateInfo = {},
  qrcodeContent
) {
  ...
  const MPTC_TEMPLATE_IMAGE = "kcit-bachelor-certificate.jpg";
  ...
  if (certificateInfo.recipient.photoBase64) {
    ...
    if (profileImage) {
      const profileMaxWidth = 343 + 55;
      const profileMaxHeight = 435 + 55;
      ...
      const profileX = (canvas.width - drawWidth) / 2 - 8;
      const profileY = 1736 + (profileMaxHeight - drawHeight) / 2;
