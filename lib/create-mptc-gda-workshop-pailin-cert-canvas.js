...
export async function createMPTCGDAWorkshopPailinCertCanvas(certificateInfo = {}, qrcodeContent) {
    ...
    const MPTC_TEXTS = [
        ...
        }, 
        {
            ...
            text: 'និងទូរគមនាគមន៍   ចាប់ពី{certificate.dateKh} នៅ{certificate.locationKh}។',
            textSize: 50,
            textColor: MPTC_TEXT_COLORS.black,      
            y: 1875,   
            align: 'center',                             
