...
export async function createSercGovernmentSecuritiesDealerAuthorizationCertificateCanvas(
    certificateInfo = {},
    qrcodeContent
) {
    ...
    const COMPANY_TEXT_MAX_WIDTH_1 = 908;
    const COMPANY_TEXT_MAX_WIDTH_2 = 790;
    const COMPANY_NUMBER_MAX_WIDTH = 425;
    const COMPANY_ADDRESS_MAX_WIDTH = 3050;
    ...
    const SERC_TEXTS = [
        ...
        {
            dataKeys: [],
            text: `សម្រេចផ្ដល់ការអនុញ្ញាតជូន`,
            textSize: 28,
            textFont: MPTC_FONTS.secondary,
            textColor: MPTC_TEXT_COLORS.black,
            x: 1190,
        ...
        {
            dataKeys: [],
            text: `ការអនុញ្ញាតនេះ  មានសុពលភាពមិនកំណត់។`,
            textSize: 30,
            textFont: MPTC_FONTS.secondary,
            textColor: MPTC_TEXT_COLORS.black,
            x: 950,
    ...
    drawWrapTexts(ctx, {
        ...
        spans: [
            {
                dataKeys: ["recipient.addresskm"],
                text: `${limitCompanyAddress} ដើម្បីប្រកបអាជីវកម្មជាអន្តរការីមូលបត្ររដ្ឋ។`,
                fontSize: 28.5,
