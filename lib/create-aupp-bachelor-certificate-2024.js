...
export async function createAUPPBachelorCertificate2024(certificateInfo = {}, qrcodeContent) {
    ...
    const AUPP_TEMPLATE_IMAGE = 'aupp-bachelor-2024-no-logo.png'
    // 'certificate-aupp-bachelor-fall-2022-with-logo.png'
    let AUPP_TEXTS = [
        {
        ...
        // hornor
        // {
        //     dataKeys: ['certificate.hornor'],
        //     text :'{certificate.hornor}',
        //     textSize: 71,
        //     textFont: AUPP_FONTS.primary,
        //     textColor: AUPP_TEXT_COLORS.black,
        //     y: 2232.3,
    ...
    if (certificateInfo.certificate.minor !== "") {
        AUPP_TEXTS.push(
            {
