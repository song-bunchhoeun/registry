...
export async function createRUPPMasterDegreeCanvas(
  certificateInfo = {},
  qrcodeContent
) {
  ...
  const educationMajor = major.toLowerCase().includes('educational administration')
  if (educationMajor) {
  ...
  const DATA = {
    BACKGROUND: {
      ...
      pngFilename: "rupp-master-background.png",
      width: 3508,
      height: 2479,
    },
    FONTS: [
