...
export async function createSercInvestmentAdvisoryAuthorizationCertificateCanvas(
    certificateInfo = {},
    qrcodeContent
) {
    ...
    const COMPANY_TEXT_MAX_WIDTH_1 = 770;
    ...
    const SERC_TEXTS = [
        ...
        },
        {
            ...
            text: `ការអនុញ្ញាតនេះ  មានសុពលភាពចាប់ពី${convertDateKm(
