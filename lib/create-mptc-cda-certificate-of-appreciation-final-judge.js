...
export async function createMPTCCDACertificateOfAppreciationFinalJudge(
  certificateInfo = {},
  qrcodeContent
) {
  ...
  const MPTC_TEMPLATE_IMAGE =
    "mptc-cda-certificate-of-appreciation-final-round-judge.jpg";
  ...
  drawWrapTexts(ctx, {
    ...
    spans: [
      {
        text: `for your invaluable contribution`,
        fontSize: 75,
  ...
  drawWrapTexts(ctx, {
    ...
    spans: [
      {
        text: `as the ${getRoleDescription(
          "final_judge",
          certificateInfo
        )} of the`,
        fontSize: 75,
