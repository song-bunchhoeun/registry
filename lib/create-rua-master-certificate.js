...
export async function createRUAMasterCertificate(
  certificateInfo = {},
  qrcodeContent,
  preview
) {
  ...
  const MPTC_TEMPLATE_IMAGE = "RUA-Master-background.jpg";
  ...
  let majorWidth;
  const majorWidthWhitelist = [
    "FOOD SCIENCE AND TECHNOLOGY",
    // Add more majors here as needed
  ];
  majorWidth = majorWidthWhitelist.includes(major) ? 760 : 640;
