...
export async function createNIEInspectorCertificate(
    certificateInfo = {},
    qrcodeContent
) {
    const DATA = {
        BACKGROUND: {
            pngFilename: "nie-inspector.jpg",
        },
        FONTS: [
    ...
    const degreeKmFontSize = adjustFontSize(ctx, nameData[0], 530);
    const nameKmFontSize = adjustFontSize(ctx, nameData[1], 1120);
    const secondDegreeKmFontSize = adjustFontSize(ctx, nameData[2], 470);
    const degreeFontSize = adjustFontSize(ctx, nameData[3], 590);
