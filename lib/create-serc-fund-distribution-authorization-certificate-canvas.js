...
export async function createSercFundDistributionAuthorizationCertificateCanvas(
    certificateInfo = {},
    qrcodeContent
) {
    ...
    const COMPANY_TEXT_MAX_WIDTH_1 = 560;
    const COMPANY_TEXT_MAX_WIDTH_2 = 790;
    const COMPANY_NUMBER_MAX_WIDTH = 425;
    const COMPANY_ADDRESS_MAX_WIDTH = 1610;
    ...
    const SERC_TEXTS = [
        ...
        {
            dataKeys: ["certificate.authorization"],
            text: `"${certificateInfo.certificate.authorization.split(" ")[0]} ${certificateInfo.certificate.authorization.split(" ")[1]}`,
            textSize: 29,
            textFont: MPTC_FONTS.primary,
            textColor: MPTC_TEXT_COLORS.black,
            x: 2037,
        ...
        {
            dataKeys: ["certificate.authorization"],
            text: `${certificateInfo.certificate.authorization.split(" ")[2]}"`,
            textSize: 29,
            textFont: MPTC_FONTS.primary,
            textColor: MPTC_TEXT_COLORS.black,
            x: 851,
