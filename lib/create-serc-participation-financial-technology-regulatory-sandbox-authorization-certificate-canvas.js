...
export async function createSercParticipationAuthorizationCertificateCanvas(
    certificateInfo = {},
    qrcodeContent
) {
    ...
    const COMPANY_TEXT_MAX_WIDTH_1 = 823;
    ...
    const SERC_TEXTS = [
        ...
        {
            dataKeys: [],
            text: `និយ័តករមូលបត្រកម្ពុជា សម្រេច${certificateInfo.certificate.issuedTypeKm}ការអនុញ្ញាតជូន`,
            textSize: 28,
            textFont: MPTC_FONTS.secondary,
            textColor: MPTC_TEXT_COLORS.black,
            x: 851,
        ...
        {
            dataKeys: [],
            text: "ដាក់ថ្នាលជួញដូរទ្រព្យឌីជីថល សម្រាប់",
            textSize: 28,
            textFont: MPTC_FONTS.secondary,
            textColor: MPTC_TEXT_COLORS.black,
            x: 2238,
        ...
        {
            dataKeys: [],
            text: "ប្រតិបត្តិការជួញដូរទ្រព្យឌីជីថល,   ជួញដូរឧបករណ៍និស្សទ្ទនៃទ្រព្យឌីជីថល    និងគ្រប់គ្រងកាបូបឌីជីថល   ក្នុងបរិស្ថានសាកល្បងបច្ចេកវិទ្យាហិរញ្ញវត្ថុក្នុងវិស័យមូលបត្រ",
            textSize: 28.5,
            textColor: MPTC_TEXT_COLORS.black,
            textFont: MPTC_FONTS.secondary,
            x: 851,
        ...
        },
        {
            ...
            text: `ការអនុញ្ញាតិនេះ  មានសុពលភាពចាប់ពី${convertDateKm(
        ...
        {
            dataKeys: [],
            text: `ការអនុញ្ញាតនេះ ត្រូវដាក់តាំងបង្ហាញជាសាធារណៈគ្រប់ពេលវេលា`,
            textSize: 23,
            textFont: MPTC_FONTS.secondary,
            textColor: MPTC_TEXT_COLORS.black,
            x: 857,
