...
export async function createMPTCUndesaCertCanvas(certificateInfo = {}, qrcodeContent) {
...
let MPTC_TEMPLATE_IMAGE = certificateInfo.certificate.category=="Certificate of Attendance"?"mptc-undesa-attendance-certificate.png":"mptc-undesa-recognition-certificate.png"
    ...
    if (qrcodeContent) {
        await drawQrCodeStandard(qrcodeContent, ctx, 3096, 1990, 296);
    }
    return canvas;
}
