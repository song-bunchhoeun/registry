...
export async function createNUMMasterCertCanvas(certificateInfo = {}, qrcodeContent) {
    ...
    const MPTC_TEMPLATE_IMAGE = 'num_master_background.jpg'
    const MPTC_TEXTS = [
        {
    ...
    if (qrcodeContent) {
        await drawQrCodeStandard(qrcodeContent, ctx, 3358, 2030, 370);
    }
