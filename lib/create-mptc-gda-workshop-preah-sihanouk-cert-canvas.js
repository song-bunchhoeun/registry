...
export async function createMPTCGDAWorkshopPreahSihanoukCertCanvas(certificateInfo = {}, qrcodeContent) {
    ...
    const MPTC_TEXTS = [
        ...
        },
        {
            ...
            text: 'for Participating in the Workshop on “Enhancing Work Performance at Post and',
            textSize: 50,
    ...
    drawLongText(possitionKhStyle, MPTC_TEXT_COLORS.blue, certificateInfo.recipient.positionKh, 1690, MPTC_FONTS, 43, ctx, canvas, bg);
    ...
    drawLongText(possitionEnStyle, MPTC_TEXT_COLORS.blue, certificateInfo.recipient.positionEn, 2174, MPTC_FONTS, 46, ctx, canvas, bg);
    ...
    drawTowCenterText(workshop1Style, MPTC_TEXT_COLORS.black, "ដែលបានចូលរួមសិក្ខាសាលា ស្តីពី ", workshop2Style, MPTC_TEXT_COLORS.black, "“", workshop3Style, MPTC_TEXT_COLORS.black, "ការពង្រឹងសមត្ថភាពអនុវត្តការងារនៅមន្ទីរប្រៃសណីយ៍", 1782, MPTC_FONTS, ctx, canvas, bg)
