...
export async function createKCNIABachelorCert(
  certificateInfo = {},
  qrcodeContent
) {
  const DATA = {
    BACKGROUND: {
      pngFilename: "kcnia-ba.jpg",
    },
    FONTS: [
  ...
  const KM_TEXTS = [
    {
      ...
      text: `${splitZeroKm()} ${dateKmIndex1} ${dateKmIndex2}`,
      textSize: 46,
  ...
  if (qrcodeContent) {
    await drawQrCodeStandard(qrcodeContent, ctx, 1610, 1868, 290);
  }
