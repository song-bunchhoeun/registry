...
export async function createCamTechTrainingCertificateCanvas(
    certificateInfo = {},
    qrcodeContent
) {
    ...
    const CAMTECH_TEMPLATE_IMAGE = "camtech-training-certificate.jpg";
    ...
    const CAMTECH_TEXTS = [
      ...
      },
      {
        ...
        text: "Certificate in {certificate.course}",
        textSize: 98,
        textColor: CAMTECH_TEXT_COLORS,
        textFont: CAMTECH_FONTS,
        y: 1954.4,
