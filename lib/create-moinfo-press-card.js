...
export async function createMoINFOPressCard(certificateInfo = {}, qrcodeContent) {
    ...
    const MPTC_TEMPLATE_IMAGE ='moinfo-press-card-front-only-v4.0.png'
    // const MPTC_TEMPLATE_IMAGE ='moinfo-press-card-front-only-v4.0.jpg'
    // const MPTC_TEMPLATE_IMAGE ='moinfo-press-card-front-only-v3.0.png'
    // const MPTC_TEMPLATE_IMAGE ='moinfo-press-card-dev.png'
