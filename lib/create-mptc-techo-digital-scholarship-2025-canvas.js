...
export async function createMPTCTeachoDigitalCert2025Canvas(
  certificateInfo = {},
  qrcodeContent
) {
  ...
  const MPTC_TEMPLATE_IMAGE =
    "certificate-techo-digital-talent-scholarship-2025.jpg";
  const MPTC_TEXTS = [
    {
    ...
    {
      dataKeys: ["certificate.yearKm"],
      text: "ដែលបានប្រឡងជាប់អាហារូបករណ៍ទេពកោសល្យឌីជីថលតេជោ ឆ្នាំ{certificate.yearKm}",
      textSize: 50,
    ...
    {
      dataKeys: ["certificate.universityKm", "certificate.degreeKm"],
      text: "សិក្សាថ្នាក់{certificate.degreeKm} នៅ{certificate.universityKm}។",
      textSize: 50,
      textColor: MPTC_TEXT_COLORS.black,
      textFont: MPTC_FONTS.secondary,
      textStyle: "medium",
