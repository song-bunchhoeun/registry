...
export async function createBIUNpAssociateCertificate(
    certificateInfo = {},
    qrcodeContent
) {
    const DATA = {
        BACKGROUND: {
            pngFilename: "biu-associate-np-certificate-2x.png",
        },
        FONTS: [
