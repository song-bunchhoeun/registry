...
export async function createMPTCGDACoordinatorThanksLetterCanvas(certificateInfo = {}, qrcodeContent) {
    ...
    const MPTC_TEXTS = [
        ...
        },
        {
            ...
            text: 'in grateful recognition of your outstanding contribution as coordinator for the workshop on',
            textSize: 50,
    ...
    drawTowCenterText(Role1Style, MPTC_TEXT_COLORS.black, "ដែលបានចូលរួមជាអ្នកសម្របសម្រួលក្នុងសិក្ខាសាលា ស្តីពី ", Role2Style, MPTC_TEXT_COLORS.black, "“", Role3Style, MPTC_TEXT_COLORS.black, "ការពង្រឹងសមត្ថភាពអនុវត្តការងារនៅ", 1770, MPTC_FONTS, ctx, canvas, bg)
