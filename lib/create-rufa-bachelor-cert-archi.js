...
export async function createRUFABachelorCertArchi(
  certificateInfo = {},
  qrcodeContent
) {
  const DATA = {
  ...
  const EN_JUSTIFY_TEXTS = [
    ...
    },
    {
      ...
      text: "examinations of the Degree in {certificate.degree}, Generation {certificate.generation},",
      textSize: 40,
      textColor: "#000000",
      textFont: DATA.FONTS[3],
      x: 1932.6,
  ...
  KM_TEXTS[0][0].text = `${kmDay} ${kmMonth} ${kmYear} ` + KM_TEXTS[0][0].text;
  ...
  EN_JUSTIFY_TEXTS[1].text = EN_JUSTIFY_TEXTS[1].text
    ...
    .replace("Faculty of ", "");
  EN_TEXTS[0][0].text =
    `held on ${enDay} ${enMonth} ${enYear}, ` + EN_TEXTS[0][0].text;
