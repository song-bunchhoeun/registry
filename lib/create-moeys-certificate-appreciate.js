...
export async function createMoEYSCertificateAppreciate(certificateInfo = {}, qrcodeContent) {
    const COLORS = {
        blue: '#003399',
        darkBlue: '#002060',
        red: '#FF0000'
    ...
    const TEXTS = [
        ...
        },
        {
            ...
            text: 'រៀននៅថ្នាក់ទី៖' + space.repeat(3) + '{certificate.classGrade}',
            textSize: 33.3,
            textColor: COLORS.darkBlue,
            x: 1158,
            y: 743,
        ...
        },
        {
            ...
            text: space.repeat(8) + '{certificate.rank}',
            textSize: 33.3,
            textColor: COLORS.red,
            x: 1105,
            y: 803,
        ...
        {
            dataKeys: ['certificate.periodTitle', 'certificate.periodValue', 'certificate.yearOfStudy'],
            text: '{certificate.periodTitle}' + space.repeat(6) + '{certificate.periodValue}' + space.repeat(36) + 'នៃឆ្នាំសិក្សា៖' + space.repeat(3) + '{certificate.yearOfStudy}',
            textSize: 33.3,
            textColor: COLORS.darkBlue,
            x: 236,
            y: 861,
