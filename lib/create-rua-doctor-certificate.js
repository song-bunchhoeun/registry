...
export async function createRUADoctorCertificate(
  certificateInfo = {},
  qrcodeContent,
  preview
) {
  ...
  const MPTC_TEMPLATE_IMAGE = "RUA-Veterinary-background.jpg";
  ...
  const ALL_MPTC_TEXTS = [
    ...MPTC_TEXTS,
    {
      ...
      textStyle: "normal",
      x: 468,
      y: majorKmHeight <= majorKmFirstHeight ? 1781 : 1870.2,
      align: "left",
      strokeLine: 0.5,
      strokeColor: MPTC_TEXT_COLORS.black,
    },
    {
      ...
      textStyle: "normal",
      x: 930,
      y: majorKmHeight <= majorKmFirstHeight ? 1865.5 : 1950,
      align: "center",
    },
    {
      dataKeys: [],
      ...
      textStyle: "normal",
      x: 930,
      y: majorKmHeight <= majorKmFirstHeight ? 1943.6 : 2020.5,
      align: "center",
      strokeLine: 0.5,
      strokeColor: MPTC_TEXT_COLORS.black,
    },
    {
      ...
      textStyle: "normal",
      x: 2240,
      y: majorHeight <= majorFirstHeight ? 1731 : 1825.2,
      align: "left",
      strokeLine: 0.5,
      strokeColor: MPTC_TEXT_COLORS.black,
    },
    {
      ...
      textStyle: "normal",
      x: 2507,
      y: majorHeight <= majorFirstHeight ? 1829 : 1920,
      align: "center",
    },
    {
      dataKeys: [],
      ...
      textStyle: "normal",
      x: 2500,
      y: majorHeight <= majorFirstHeight ? 1894.6 : 1990,
      align: "center",
      strokeLine: 0.5,
      strokeColor: MPTC_TEXT_COLORS.black,
    },
