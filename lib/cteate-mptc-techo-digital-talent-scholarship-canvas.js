...
export async function createMPTCTeachoDigitalTalentCertCanvas(certificateInfo = {}, qrcodeContent) {
    ...
    const MPTC_TEMPLATE_IMAGE = 'certificate-techo-digital-talent-scholarship-with-stamp-2023.png';
    const MPTC_TEXTS = [
        {
        ...
        ,
        {
            dataKeys: ['certificate.yearEn'],
            text: `who has been awarded a {certificate.yearEn} Techo Digital Talent Scholarship`,
            textSize: 50,
            textColor: MPTC_TEXT_COLORS.black,     
            textFont: MPTC_FONTS.fouthly, 
            textStyle:'meduim',    
        ...
        {
            dataKeys: ['certificate.universityEn','certificate.degreeEn'],
            text: `to pursue a {certificate.degreeEn} at {certificate.universityEn}.`,
            textSize: 50,
            textColor: MPTC_TEXT_COLORS.black,    
            textFont: MPTC_FONTS.fouthly,             
            align: 'center',
