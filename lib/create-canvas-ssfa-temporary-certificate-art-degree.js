...
// Temporary Certificate of Art Certificate
export async function createCanvasSSFATemporaryCertificateArtDegree(
  certificateInfo = {},
  qrcodeContent
) {
  ...
  // const SSFA_TEMPLATE_IMAGE = "ssfa-temporary-baccalaureate.png";
  const SSFA_TEMPLATE_IMAGE = "certificate-ssfa-temporary-baccaluarate.png";
