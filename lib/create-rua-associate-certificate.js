...
export async function createRUAAssociateCertificate(
  certificateInfo = {},
  qrcodeContent,
  preview
) {
  ...
  const MPTC_TEMPLATE_IMAGE = "RUA-Associate-background.jpg";
  ...
  const ALL_MPTC_TEXTS = [
    ...MPTC_TEXTS,
    {
      ...
      textStyle: "normal",
      x: 485.6,
      y: majorKmHeight <= majorKmFirstHeight ? 1721.2 : 1840.2,
      align: "left",
      strokeLine: 0.5,
      strokeColor: MPTC_TEXT_COLORS.black,
    },
    {
      ...
      textStyle: "normal",
      x: 940,
      y: majorKmHeight <= majorKmFirstHeight ? 1807.3 : 1920,
      align: "center",
    },
    {
      dataKeys: [],
      ...
      textStyle: "normal",
      x: 940,
      y: majorKmHeight <= majorKmFirstHeight ? 1883.5 : 2000.5,
      align: "center",
      strokeLine: 0.5,
      strokeColor: MPTC_TEXT_COLORS.black,
    },
    {
      ...
      text:
        "Phnom Penh " +
        removeLeadingZero(certificateInfo.certificate.rectorSignatureDate),
      textSize: 50,
      textColor: MPTC_TEXT_COLORS.black,
      textFont: MPTC_FONTS.secondary,
      textStyle: "normal",
      x: 2220,
      y: majorHeight <= majorFirstHeight ? 1634.5 : 1795.2,
      align: "left",
      strokeLine: 0.5,
      strokeColor: MPTC_TEXT_COLORS.black,
    },
    {
      ...
      textStyle: "normal",
      x: 2487,
      y: majorHeight <= majorFirstHeight ? 1736.7 : 1890,
      align: "center",
    },
    {
      dataKeys: [],
      ...
      textStyle: "normal",
      x: 2500,
      y: majorHeight <= majorFirstHeight ? 1810.7 : 1960,
      align: "center",
      strokeLine: 0.5,
      strokeColor: MPTC_TEXT_COLORS.black,
    },
  ...
  if (qrcodeContent) {
    await drawQrCodeStandard(qrcodeContent, ctx, 1591, 1791, 320);
  }
