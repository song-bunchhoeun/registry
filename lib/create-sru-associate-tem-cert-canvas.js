...
export async function createSRUAssociateTemCertCanvas(
  certificateInfo = {},
  qrcodeContent,
) {
  const TEXT_COLORS = {
  ...
  if (certificateInfo.certificate.type === "ប្រឡង") {
    certificateType = "sru-associate-exam-certificate.jpg";
  } else {
    certificateType = "sru-associate-thesis-certificate.jpg";
  }
