...
export async function createSRUBachelorCertificateCanvas(
  certificateInfo = {},
  qrcodeContent
) {
  ...
  const MPTC_TEMPLATE_IMAGE = "sru-bachelor-certificate.jpg";
  ...
  if (certificateInfo.recipient.photoBase64) {
    ...
    if (profileImage) {
      ...
      const profileX = 1611 + (profileMaxWidth - drawWidth) / 2;
