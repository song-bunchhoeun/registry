...
export async function createSRUAssociateCertificateCanvas(
  certificateInfo = {},
  qrcodeContent
) {
  ...
  const MPTC_TEMPLATE_IMAGE = "sru-associate-certificate.jpg";
  ...
  const SRU_TEXTS = [
    ...
    },
    {
      ...
      text: `in ${certificateInfo.certificate.degree}`,
      textSize: 63,
      textColor: MPTC_TEXT_COLORS.blue,
