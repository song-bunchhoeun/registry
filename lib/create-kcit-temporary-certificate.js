...
export async function createKCITTemporaryCertificate(certificateInfo = {}, qrcodeContent) {
    ...
    const MPTC_TEMPLATE_IMAGE = 'certificate-associate-temporary-kcit.png'
    ...
    if (qrcodeContent) {
        await drawQrCodeStandard(qrcodeContent, ctx, 237, 2895, 322);
    }
