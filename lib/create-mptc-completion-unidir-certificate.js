...
export async function createMptcCompletionUnidirCertificate(
  certificateInfo = {},
  qrcodeContent,
) {
  ...
  const MPTC_FONTS = {
    khmerDigitalExtraBold: "Khmer Digital ExtraBold",
    khmerDigital: "Khmer Digital",
  };
  const MPTC_TEMPLATE_IMAGE =
    "mptc-workshop-of-cyber-unidir-certificate.jpg";
  ...
  if (qrcodeContent) {
    await drawQrCodeStandard(qrcodeContent, ctx, 2882, 1773, 340);
  }
  return canvas;
}
