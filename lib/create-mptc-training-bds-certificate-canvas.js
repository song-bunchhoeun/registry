...
export async function createMPTCTrainingBDSCertificateCanvas(
    certificateInfo = {},
    qrcodeContent
) {
    ...
    const MPTC_TEMPLATE_IMAGE = 'mptc-training-bds-background.jpg';
    ...
    const drawDateLocation = drawWrapTexts(ctx, {
        ...
        spans: [
            {
                text: certificateInfo.certificate.date + ` at ` + certificateInfo.certificate.location + `.`,
                fontSize: 50,
