...
export async function createRUPPBachelorDegreeCanvas(
  certificateInfo = {},
  qrcodeContent,
) {
  const RUPP_TEXT_COLORS = {
    black: "#000000",
    blue: "#000000",
  };
  ...
  let degreeKm = certificateInfo.certificate.degreeKm.split("បរិញ្ញាបត្រ");
  ...
  degreeKm = `បរិញ្ញាបត្រ   ${degreeKm[1]} `;
  ...
  if (educationMajor) {
    major0 = "in " + major.split(" in ")[0].trim();
    major1 = "in " + major.split(" in ")[1].trim();
  }
  ...
  const DATA = {
    BACKGROUND: {
      // pngFilename: "rupp-v3-center-no-text.jpg",
      pngFilename: "rupp-bachelor-background.png",
      width: 3508,
      height: 2479,
    },
    FONTS: [
    ...
    TEXTS: [
      {
        ...
        text: name,
        textSize: 46,
        textColor: RUPP_TEXT_COLORS.blue,
        textStyle: "bold",
        textFont: {
          name: RUPP_FONTS.timesNewRoman,
          filename: "timesbd.ttf",
      ...
      },
      {
        ...
        text: educationMajor ? major0 : major,
        textSize: 51,
        textColor: RUPP_TEXT_COLORS.blue,
        textFont: {
          name: RUPP_FONTS.timesNewRoman,
      ...
      {
        dataKeys: [],
        text: "in recognition of the fulfillment of all requirements for this degree.",
        textSize: 51,
        textColor: RUPP_TEXT_COLORS.blue,
        textFont: {
          name: RUPP_FONTS.timesNewRoman,
        ...
        x: 1047.5,
        y: educationMajor ? 1428.9 : 1341.6,
        align: "center",
      },
      {
