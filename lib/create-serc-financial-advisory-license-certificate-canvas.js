...
export async function createSercFinancialAdvisoryLicenceCertificateCanvas(
    certificateInfo = {},
    qrcodeContent
) {
    ...
    const COMPANY_TEXT_MAX_WIDTH_1 = 785;
    ...
    const SERC_TEXTS = [
        ...
        {
            dataKeys: [],
            text: `និយ័តករមូលបត្រកម្ពុជា សម្រេចផ្ដល់អាជ្ញាបណ្ណជូន `,
            textSize: 28,
            textFont: MPTC_FONTS.secondary,
            textColor: MPTC_TEXT_COLORS.black,
            x: 851,
